...
public class CircularProgress: UIView {
    ...
    private class KDCircularProgressViewLayer: CALayer {
        ...
        private  func drawProgressText(){
            let progress=100
            let rect = bounds
            
            let str: NSString = String(progress)
            ...
            str.drawInRect(CGRectMake(rect.size.width/2.5, rect.size.height/2.5, rect.size.height/2, rect.size.width/2), withAttributes: attributes as! [String : AnyObject])
            
            
            let str2: NSString = "%"
            let fieldFont2 = UIFont(name: "Helvetica Neue", size: 30)
            ...
            str2.drawInRect(CGRectMake(rect.size.width/2.5 + CGFloat(text_shift), rect.size.height/2.1, rect.size.height/2, rect.size.width/2), withAttributes: attributes2 as! [String : AnyObject])
